...
if __name__ == "__main__":
    ...
    hash_result = hash_generator.generate_hash(utxo_1,utxo_2, output_address, amount,signature)
    print(hash_result)

    # Print counts
    for idx, component in enumerate([utxo_1,utxo_2, output_address, amount,signature]):
