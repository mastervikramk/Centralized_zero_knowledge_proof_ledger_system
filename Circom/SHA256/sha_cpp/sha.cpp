...
void hasher_99_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void hasher_99_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 204268;}

uint get_number_of_components() {return 1811;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 28643;}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 20
while(Fr_isTrue(&expaux[0])){
{
...
// load src
Fr_shr(&expaux[1],&circuitConstants[2],&lvar[2]); // line circom 30
...
hasher_99_create(1,0,ctx,"main",0);
hasher_99_run(0,ctx);
}
